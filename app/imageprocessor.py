...
class ImageProcessor:
    ...
    def process(self):
        ...
        for (x, y, width, height) in faces:
            ...
            text_second_place = f'{preds[1][0]}: {(preds[1][1]*100):3.1f}%'

            cv2.putText(self._decoded, text_first_place, (x, y-20), self.font, .5, (255, 0, 255), 1)
            cv2.putText(self._decoded, text_second_place, (x, y-5), self.font, .5, (255, 0, 255), 1)
